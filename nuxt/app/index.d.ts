...
// Fix for import.meta TypeScript errors - Nuxt provides these
...
// Extend ImportMeta for Nuxt's server/client detection
...
type HttpUseFetchOptions<T> = Omit<UseFetchOptions<T>, '$fetch'> & HttpFetchOptions;
