  ...
  <div>
    ...
    <nav class="max-w-7xl mx-auto px-4 py-4">
      <ul class="flex gap-2 text-sm">
        ...
        <li><NuxtLink to="/collection" class="text-blue-600 hover:underline">Bộ sưu tập</NuxtLink></li>
        <li class="text-slate-600">/</li>
        <li class="text-slate-900 dark:text-white font-semibold">Jujutsu Kaisen</li>
      </ul>
    </nav>
      ...
      <div class="max-w-7xl mx-auto px-4 py-8">
        <div class="grid md:grid-cols-3 gap-8">
          ...
          <div class="md:col-span-2">
            <h1 class="text-4xl font-bold text-slate-900 dark:text-white mb-2">Jujutsu Kaisen</h1>
            <p class="text-lg text-slate-600 dark:text-slate-400 mb-4">Gege Akutami</p>
            ...
            <div class="flex items-center gap-6 mb-6 text-sm">
              <div class="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p class="text-slate-600 dark:text-slate-400">Dựa trên 5.2K đánh giá</p>
                </div>
              </div>
              <div>
            ...
            <p class="text-slate-700 dark:text-slate-300 mb-6 leading-relaxed">
              Jujutsu Kaisen là một bộ truyện tranh về những người có khả năng phép thuật và cuộc chiến chống lại những sinh vật siêu nhiên. Bộ truyện kết hợp hành động, bí ẩn và các yếu tố kỳ ảo tạo nên một câu chuyện hấp dẫn.
            </p>

            <div class="mb-6">
              <h4 class="font-semibold text-slate-900 dark:text-white mb-3">Thể loại:</h4>
      ...
      <UTabs :items="tabs" class="w-full">
        <template #chapters>
          <div class="space-y-2 mt-4">
            <NuxtLink
              ...
              :key="chapter.id"
              :to="`/comic/1/chapter/${chapter.number}`"
              class="block p-4 bg-white dark:bg-slate-800 hover:bg-blue-50 dark:hover:bg-slate-700 rounded-lg transition-colors border border-slate-200 dark:border-slate-700"
            >
        ...
        <template #comments>
          <div class="mt-4">
            <CommentSection
              :comments="comments"
              user-avatar="https://via.placeholder.com/40x40"
              user-id="user-123"
              :show-rating="true"
            />
          </div>
