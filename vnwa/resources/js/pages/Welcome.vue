    ...
    <div
        ...
        <div
            ...
            <main
                ...
                <div
                    ...
                    <ul class="mb-4 flex flex-col lg:mb-6">
                        <li
                            ...
                            <span>
                                Read the
                                <a href="https://vinawebapp.com/" target="_blank"
                                    class="ml-1 inline-flex items-center space-x-1 font-medium text-[#8254b8] underline underline-offset-4 dark:text-[#c899ff]">
                    ...
                    <ul class="flex gap-3 text-sm leading-normal">
                        <li>
                            <Link v-if="$page.props.auth.user" :href="dashboard()"
                                class="inline-block rounded-sm border border-black bg-[#8254b8] px-5 py-1.5 text-sm leading-normal text-white hover:border-black hover:bg-black dark:border-[#8254b8] dark:bg-[#8254b8] dark:text-[#fff]  ">
                                Dashboard
                            </Link>
                            <template v-else>
                                <Link :href="login()"
                ...
                <div
                    class="relative -mb-px aspect-335/376 w-full shrink-0 overflow-hidden rounded-t-lg bg-zinc-50 lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[438px] lg:rounded-t-none lg:rounded-r-lg dark:bg-zinc-900">
                    <img src="/vnwa/vnwa_icon.webp" alt="Welcome" class="w-full h-full object-cover">
                </div>
            </main>
        </div>
