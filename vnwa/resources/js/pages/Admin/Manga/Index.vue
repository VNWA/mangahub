                ...
                <CardContent class="p-4">
                    <div class="flex flex-col gap-4 sm:flex-row">
                        <div class="relative flex-1">
                            ...
                            <Input v-model="searchQuery" type="text" placeholder="Tìm kiếm manga..." class="pl-9 pr-9"
                        ...
                        <div class="flex gap-2">
                            ...
                            <Button v-if="searchQuery || statusFilter" variant="outline" @click="clearFilters">
                    ...
                    <CardContent class="p-0">
                        <div class="overflow-x-auto">
                            <table class="w-full">
                                ...
                                <!-- Table Body -->
                                <tbody>
                                    <tr v-for="manga in props.mangas.data" :key="manga.id"
                                        class="border-b transition-colors hover:bg-muted/50">
                                        <!-- Avatar Cell -->
                                        <td class="p-4 align-middle">
                                            <div
                                                class="relative h-16 w-12 shrink-0 overflow-hidden rounded border bg-muted">
                                                <img v-if="manga.avatar" :src="manga.avatar_url" :alt="manga.name"
                                        ...
                                        <!-- Categories Cell -->
                                        <td class="p-4 align-middle">
                                            <div v-if="manga.categories && manga.categories.length > 0"
                                                class="flex flex-wrap gap-1">
                                                <Badge v-for="category in manga.categories.slice(0, 2)"
                                                    :key="category.id" variant="outline" class="text-xs">
                                                    {{ category.name }}
                                                </Badge>
                                                <Badge v-if="manga.categories.length > 2" variant="outline"
                                                    class="text-xs">
