...
const submit = async () => {
    try {
        const response = await window.axios.post(mangas.store().url, form.value);
        if (response.data?.success) {
            toast.success(response.data.message || 'Manga đã được tạo thành công.');
                        ...
                        <Card>
                            ...
                            <CardContent>
                                ...
                                <p v-if="props.categories.length === 0" class="text-sm text-muted-foreground">
                                    Chưa có category nào. <Link :href="categories.create().url"
                                        class="text-primary hover:underline">Tạo category mới</Link>
                                </p>
                            </CardContent>
                        </Card>
                    </div>
                        ...
                        <Card>
                            ...
                            <CardContent class="space-y-4">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <p class="text-xs text-muted-foreground">
                                        <Link :href="authors.create().url" class="text-primary hover:underline">Tạo tác
                                            giả mới</Link>
                                    </p>
                                </div>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <p class="text-xs text-muted-foreground">
                                        <Link :href="badges.create().url" class="text-primary hover:underline">Tạo badge
                                            mới</Link>
                                    </p>
                                </div>
